         ...
         <div className="article-info-content">
            ...
            <div className="article-info-parag py-4">
               ...
               <ul className="text-numeric-list">
                  ...
                  <li>
                     <p className="article-info-text ps-2">
                        The entire platform can be modified and customised to
                        suit your needs. It's very powerful, but does require
                        some knowledge of code. Ghost is not necessarily a good
                  ...
                  <li>
                     <p className="article-info-text ps-2">
                        It's possible to work with all your favourite tools and
                        apps with hundreds of integrations to speed up your
                        workflows, connect email lists, build communities and
                        much more
                     </p>
                  </li>
               </ul>
            ...
            <div className="article-info-parag py-4">
               ...
               <p className="article-info-text ps-2 pb-4">
                  The main thing you'll want to read about next is probably: the
                  Ghost editor. This is where the good stuff happens.
               </p>
